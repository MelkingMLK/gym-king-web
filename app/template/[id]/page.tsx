...
import { ChevronLeft, Trash2, Edit3, ChevronRight, X } from "lucide-react";
...
export default function TemplateDetailPage() {
  ...
  // FUNZIONE PER RINOMINARE IL TEMPLATE
  ...
  return (
    <main className="flex min-h-screen flex-col items-center pt-12 px-4 pb-20 relative overflow-x-hidden bg-base transition-colors duration-300">
      ...
      <div className="w-full max-w-2xl flex flex-col gap-5 relative z-10">
        {giorni.map((giorno) => (
          <div key={giorno.id_giorno} className="w-full bg-surface border-2 border-line p-5 flex items-center justify-between shadow-[6px_6px_0px_#000000] dark:shadow-[6px_6px_0px_#804CD9] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_#000000] dark:hover:shadow-[4px_4px_0px_#804CD9]">
